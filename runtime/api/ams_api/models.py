...
metadata = MetaData()
academy = Table("Academy", metadata, Column("id", UUID(as_uuid=True), primary_key=True), Column("name", String), Column("slug", String), Column("active", Boolean), Column("timezone", String), Column("createdAt", DateTime(timezone=True)))
